...
def change_spacing(path, spacing, new_path):
    img_array = sitk.GetArrayFromImage(sitk.WriteImage(path))
...
def pre_for_fsl(path):
    ...
    print("已对{}进行预处理，并重新保存到原始地址！".format(path))
